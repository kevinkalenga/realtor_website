/*
https://console.cloud.google.com/google/maps-apis/credentials?utm_source=Docs_CreateAPIKey&utm_content=Docs_geocoding-backend&hl=fr&_gl=1*16ng54v*_ga*MjkyNTU0NTQ5Ni4xNzE4MDY2NjI3*_ga_NRWSTWS78N*MTcyODYzMTU1OC4yLjEuMTcyODYzNTEwOC4wLjAuMA..&project=realtor-website-react-9eb4d
...
//         // AIzaSyB9SOlDIe09_x1eeCDcRXZo8PXbZjOjWXQ
...
//                    value = {bedrooms} onChange={onChange} min="1" 
//                    max="50" required 
//                    className='px-4 py-2 text-xl text-gray-300 bg-white
...
//                    value = {bathrooms} onChange={onChange} min="1" 
//                    max="50" required 
//                    className='px-4 py-2 text-xl text-gray-300 bg-white
//                    border border-gray-700 rounded transition duration-150 ease-in-out
//                    focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
...
//                        onChange={onChange} required min="-90" max="90" className='w-full px-4 py-2 text-xl
...
//                        <input type="number" id="latitude" value={longitude} 
//                        onChange={onChange} required min="-180" max="180" className='w-full px-4 py-2 text-xl
//                        text-gray-700 bg-white border border-gray-300 rounded transition
//                        duration-150 ease-in-out focus:bg-white focus:text-gray-700
//                        focus:border-slate-600 text-center'/>
//                     </div>
...
//                         min="50" max="4000000000" 
//                         required={offer} className='w-full px-4 py-2 text-xl
//                          text-gray-700 bg-white border
//                           border-gray-300 rounded transition duration-150 
//                           ease-in-out focus:text-gray-700 focus:bg-white
//                           focus:border-slate-600 text-center'/>
