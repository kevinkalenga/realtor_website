            ...
            <form >
              ...
              <div className='relative mb-6'>
                ...
                />
                {
                  showPassword ? (<AiFillEyeInvisible className='absolute 
                    right-3 top-3 text-xl cursor-pointer' onClick={() =>setShowPassword((prevState)=>!prevState)} />
              ...
              <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
               ...
               <button className='w-full bg-blue-600 text-white 
                px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 
